                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setFormData(prev => ({ ...prev, visitTarget: e.target.value }))}
                        className="w-full px-4 py-3 bg-white/50 border border-white/40 rounded-lg text-slate-700 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-navy-400 focus:border-transparent backdrop-blur-xl"
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <label className="flex items-center space-x-3 cursor-pointer">
                          <input
                            type="checkbox"
                            checked={formData.noCompanions}
                            onChange={(e) => {
                              const checked = e.target.checked;
                              setFormData(prev => ({ 
                                ...prev, 
                                noCompanions: checked,
                          ...
                          />
                          <span className="text-slate-700 font-medium">同行者なし</span>
                        </label>
                        {!formData.noCompanions && (
                          <input
                            type="text"
